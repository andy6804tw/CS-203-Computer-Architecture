...
# #用到的寄存器对应的编号
# Regs={'F0':0,'F2':2,'F4':4,'F6':6,'F8':8,'F10':10,'F12':11,'F14':12,'R2':13,'R3':14,}

# #寄存器及其存储值的映射表
# registers={'F0':'F0','F2':'F2','F4':'F4','F6':'F6','F8':'F8','F10':'F10','F12':'F12','F14':'F14','R2':'R2','R3':'R3',}

# #Qi为寄存器状态指示表，可指明各寄存器的值是可以直接使用还是需要等待保留站的写入，初始为0表示所有寄存器都可用
# Qi={'F0':0,'F2':0,'F4':0,'F6':0,'F8':0,'F10':0,'F12':0,'F14':0,'R2':0,'R3':0,}
