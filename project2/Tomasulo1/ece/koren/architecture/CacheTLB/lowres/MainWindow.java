...
*/	
		...
		pageSizeList.setBounds(180,10,80,30);
		inputPanel.add(mmSizeList);
		mmSizeList.setBounds(180,40,80,30);
		inputPanel.add(tlbSizeTxt);
		tlbSizeTxt.setBounds(180,70,80,20);
		inputPanel.add(l2CacheSizeList);
		l2CacheSizeList.setBounds(180,100,80,30);
		inputPanel.add(l2BlockSizeList);
		l2BlockSizeList.setBounds(180,130,80,30);
		inputPanel.add(l2PolicyList);
		l2PolicyList.setBounds(180,160,80,30);
		inputPanel.add(l2ReplacementPolicyList);
		l2ReplacementPolicyList.setBounds(180,190,80,30);
		inputPanel.add(l1CacheSizeList);
		l1CacheSizeList.setBounds(180,220,80,30);
		inputPanel.add(l1BlockSizeList);
		l1BlockSizeList.setBounds(180,250,80,30);
		inputPanel.add(l1PolicyList);
		l1PolicyList.setBounds(180,280,80,30);
		inputPanel.add(l1ReplacementPolicyList);
		l1ReplacementPolicyList.setBounds(180,310,80,30);		
		inputPanel.add(mmPolicyList);
		mmPolicyList.setBounds(180,340,80,30);
		inputPanel.add(brkPointList);
		brkPointList.setBounds(180,370,80,30);
		inputPanel.add(cacheLevelList);
		cacheLevelList.setBounds(180,400,80,30);
		inputPanel.add(traceSelectList);
		traceSelectList.setBounds(180,435,80,30);
		inputPanel.add(urlTxt);
		urlTxt.setBounds(180,465,80,20);
		
		
		getContentPane().add(inputPanel);
		inputPanel.setBounds(-30, 40, 270, 500);
		...
		hdrLabel.setBounds(280, 10, 300, 20);
		...
		startButton.setBounds(0, 0, 120, 30);
		...
		runButton.setBounds(120, 0, 120, 30);
		...
		clearButton.setBounds(0, 30, 120, 30);
		...
		partRunButton.setText("Run upto Break Pt");
		buttonPanel.add(partRunButton);
		partRunButton.setBounds(120, 30, 120, 30);
		...
		buttonPanel.setBounds(0, 540,240, 60);
		...
		outputPane.setBounds(0, 20, 280, 140);
		...
		lbDefTxt.setBounds(280,0,280,20);
		outputPanel.add(lbDefTxt);
		
		outputPanel.add(label1);
		label1.setBounds(290,40,150,15);
		outputPanel.add(label2);
		label2.setBounds(290,60,150,15);
		outputPanel.add(label3);
		label3.setBounds(290,80,150,15);
		outputPanel.add(label4);
		label4.setBounds(290,100,150,15);
		outputPanel.add(label5);
		label5.setBounds(290,120,200,15);
		outputPanel.add(label6);
		label6.setBounds(290,140,200,15);
		outputPanel.add(label7);
		label7.setBounds(290,170,200,15);
		
		outputPanel.add(label1Txt);
		label1Txt.setBounds(500,40,50,15);
		outputPanel.add(label2Txt);
		label2Txt.setBounds(500,60,50,15);
		outputPanel.add(label3Txt);
		label3Txt.setBounds(500,80,50,15);
		outputPanel.add(label4Txt);
		label4Txt.setBounds(500,100,50,15);
		outputPanel.add(label5Txt);
		label5Txt.setBounds(500,120,50,15);
		outputPanel.add(label6Txt);
		label6Txt.setBounds(500,140,50,15);
		...
		defaultPane.setBounds(280, 20, 280, 140);
...
//		defaultText.setText(getConstants());
		...
		outputPanel.setBounds(240, 440, 560, 160);
	...
	private void createTables()
	{
		...
		memRefJsp.setBounds(0, 20, 140, 380);
		tblPanel.add(memRefJsp);
		//memRefTbl.setToolTipText("Memory References");
		
		JLabel lbMemRefTab=new JLabel("Memory References");
		...
		lbMemRefTab.setBounds(0,0,140,20);
		...
		tlbJsp.setBounds(140, 20, 140, 180);
		tblPanel.add(tlbJsp);
		...
		lbTlbTab.setBounds(140,0,140,20);
		...
		ptJsp.setBounds(140, 220, 140, 180);
		tblPanel.add(ptJsp);
		...
		lbPgTab.setBounds(140,200,140,20);
		...
		l1iJsp.setBounds(280, 20, 140, 180);
		tblPanel.add(l1iJsp);
		...
		lbL1ICacheTab.setBounds(280,0,140,20);
		...
		l1dJsp.setBounds(280, 220, 140, 180);
		tblPanel.add(l1dJsp);
		...
		lbL1DCacheTab.setBounds(280,200,140,20);
		...
		l2Jsp.setBounds(420, 20, 140, 180);
		tblPanel.add(l2Jsp);
		...
		lbL2CacheTab.setBounds(420,0,140,20);
		...
		mmJsp.setBounds(420, 220, 140, 180);
		tblPanel.add(mmJsp);
		...
		lbMMTab.setBounds(420,200,140,20);
		tblPanel.add(lbMMTab);
		
		getContentPane().add(tblPanel);
		tblPanel.setBounds(240, 40, 560, 400);
