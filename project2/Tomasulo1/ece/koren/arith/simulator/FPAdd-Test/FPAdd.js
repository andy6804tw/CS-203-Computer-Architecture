...
//	document.writeln("<HR>")
    ...
    f1sign = Struct1.realSign;
    f2sign = Struct2.realSign;

    if(Subtract && (Struct2.realSign!=-1))
    {
        f2sign = -1;
    }
    else if(Subtract && (Struct2.realSign==-1))
    {
        f2sign = 1;
    }
    ...
    {
        if(((f1sign != f2sign) && (f1 > f2) && !(Struct1.G || Struct1.R || Struct1.S)))
          {
          ...
          else if(((f2sign != f1sign)&& (f2 > f1) && !(Struct2.G || Struct2.R || Struct2.S)))
          {
              carryin = Math.pow(2,-23);
              if(f1 < f2)
              {
	...
	//    else
	    {
            ...
            GRSf3=f1sign*(asign*8 + Struct1.G*4 + Struct1.R*2 + Struct1.S)+ f2sign*(bsign*8 + Struct2.G*4+Struct2.R*2+Struct2.S);
        }
